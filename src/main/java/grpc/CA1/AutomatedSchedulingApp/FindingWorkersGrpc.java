...
public final class FindingWorkersGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<grpc.CA1.AutomatedSchedulingApp.TaskSpecifications,
      grpc.CA1.AutomatedSchedulingApp.TaskMatch> getTaskFindingMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "taskFinding",
      requestType = grpc.CA1.AutomatedSchedulingApp.TaskSpecifications.class,
      responseType = grpc.CA1.AutomatedSchedulingApp.TaskMatch.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<grpc.CA1.AutomatedSchedulingApp.TaskSpecifications,
      grpc.CA1.AutomatedSchedulingApp.TaskMatch> getTaskFindingMethod() {
    io.grpc.MethodDescriptor<grpc.CA1.AutomatedSchedulingApp.TaskSpecifications, grpc.CA1.AutomatedSchedulingApp.TaskMatch> getTaskFindingMethod;
      ...
      synchronized (FindingWorkersGrpc.class) {
        if ((getTaskFindingMethod = FindingWorkersGrpc.getTaskFindingMethod) == null) {
          FindingWorkersGrpc.getTaskFindingMethod = getTaskFindingMethod = 
              io.grpc.MethodDescriptor.<grpc.CA1.AutomatedSchedulingApp.TaskSpecifications, grpc.CA1.AutomatedSchedulingApp.TaskMatch>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "FindingWorkers", "taskFinding"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  grpc.CA1.AutomatedSchedulingApp.TaskSpecifications.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  grpc.CA1.AutomatedSchedulingApp.TaskMatch.getDefaultInstance()))
  ...
  public static abstract class FindingWorkersImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void taskFinding(grpc.CA1.AutomatedSchedulingApp.TaskSpecifications request,
        io.grpc.stub.StreamObserver<grpc.CA1.AutomatedSchedulingApp.TaskMatch> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                grpc.CA1.AutomatedSchedulingApp.TaskSpecifications,
                grpc.CA1.AutomatedSchedulingApp.TaskMatch>(
  ...
  public static final class FindingWorkersBlockingStub extends io.grpc.stub.AbstractStub<FindingWorkersBlockingStub> {
    ...
    /**
     */
    public grpc.CA1.AutomatedSchedulingApp.TaskMatch taskFinding(grpc.CA1.AutomatedSchedulingApp.TaskSpecifications request) {
  ...
  public static final class FindingWorkersFutureStub extends io.grpc.stub.AbstractStub<FindingWorkersFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<grpc.CA1.AutomatedSchedulingApp.TaskMatch> taskFinding(
        grpc.CA1.AutomatedSchedulingApp.TaskSpecifications request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_TASK_FINDING:
          serviceImpl.taskFinding((grpc.CA1.AutomatedSchedulingApp.TaskSpecifications) request,
              (io.grpc.stub.StreamObserver<grpc.CA1.AutomatedSchedulingApp.TaskMatch>) responseObserver);
          break;
        default:
  ...
  private static abstract class FindingWorkersBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return grpc.CA1.AutomatedSchedulingApp.projectManagerSchedule.getDescriptor();
    }
