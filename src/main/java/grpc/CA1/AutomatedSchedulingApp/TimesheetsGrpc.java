...
@javax.annotation.Generated(
    ...
    comments = "Source: AutomatedSchedulingApp.proto")
public final class TimesheetsGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<grpc.CA1.AutomatedSchedulingApp.profile,
      grpc.CA1.AutomatedSchedulingApp.success> getIntroduceProfileMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "IntroduceProfile",
      requestType = grpc.CA1.AutomatedSchedulingApp.profile.class,
      responseType = grpc.CA1.AutomatedSchedulingApp.success.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<grpc.CA1.AutomatedSchedulingApp.profile,
      grpc.CA1.AutomatedSchedulingApp.success> getIntroduceProfileMethod() {
    io.grpc.MethodDescriptor<grpc.CA1.AutomatedSchedulingApp.profile, grpc.CA1.AutomatedSchedulingApp.success> getIntroduceProfileMethod;
      ...
      synchronized (TimesheetsGrpc.class) {
        if ((getIntroduceProfileMethod = TimesheetsGrpc.getIntroduceProfileMethod) == null) {
          TimesheetsGrpc.getIntroduceProfileMethod = getIntroduceProfileMethod = 
              io.grpc.MethodDescriptor.<grpc.CA1.AutomatedSchedulingApp.profile, grpc.CA1.AutomatedSchedulingApp.success>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "Timesheets", "IntroduceProfile"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  grpc.CA1.AutomatedSchedulingApp.profile.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  grpc.CA1.AutomatedSchedulingApp.success.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<grpc.CA1.AutomatedSchedulingApp.absenceRequest,
      grpc.CA1.AutomatedSchedulingApp.success> getAbsenceEmptyAgendaMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "AbsenceEmptyAgenda",
      requestType = grpc.CA1.AutomatedSchedulingApp.absenceRequest.class,
      responseType = grpc.CA1.AutomatedSchedulingApp.success.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<grpc.CA1.AutomatedSchedulingApp.absenceRequest,
      grpc.CA1.AutomatedSchedulingApp.success> getAbsenceEmptyAgendaMethod() {
    io.grpc.MethodDescriptor<grpc.CA1.AutomatedSchedulingApp.absenceRequest, grpc.CA1.AutomatedSchedulingApp.success> getAbsenceEmptyAgendaMethod;
      ...
      synchronized (TimesheetsGrpc.class) {
        if ((getAbsenceEmptyAgendaMethod = TimesheetsGrpc.getAbsenceEmptyAgendaMethod) == null) {
          TimesheetsGrpc.getAbsenceEmptyAgendaMethod = getAbsenceEmptyAgendaMethod = 
              io.grpc.MethodDescriptor.<grpc.CA1.AutomatedSchedulingApp.absenceRequest, grpc.CA1.AutomatedSchedulingApp.success>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
              .setFullMethodName(generateFullMethodName(
                  "Timesheets", "AbsenceEmptyAgenda"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  grpc.CA1.AutomatedSchedulingApp.absenceRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  grpc.CA1.AutomatedSchedulingApp.success.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<grpc.CA1.AutomatedSchedulingApp.absenceRequest,
      grpc.CA1.AutomatedSchedulingApp.success> getAbsenceFullAgendaMethod;
  ...
  public static io.grpc.MethodDescriptor<grpc.CA1.AutomatedSchedulingApp.absenceRequest,
      grpc.CA1.AutomatedSchedulingApp.success> getAbsenceFullAgendaMethod() {
    io.grpc.MethodDescriptor<grpc.CA1.AutomatedSchedulingApp.absenceRequest, grpc.CA1.AutomatedSchedulingApp.success> getAbsenceFullAgendaMethod;
  ...
  public static abstract class TimesheetsImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void introduceProfile(grpc.CA1.AutomatedSchedulingApp.profile request,
        io.grpc.stub.StreamObserver<grpc.CA1.AutomatedSchedulingApp.success> responseObserver) {
      asyncUnimplementedUnaryCall(getIntroduceProfileMethod(), responseObserver);
    }

    /**
     */
    public void absenceEmptyAgenda(grpc.CA1.AutomatedSchedulingApp.absenceRequest request,
        io.grpc.stub.StreamObserver<grpc.CA1.AutomatedSchedulingApp.success> responseObserver) {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<grpc.CA1.AutomatedSchedulingApp.absenceRequest> absenceFullAgenda(
        io.grpc.stub.StreamObserver<grpc.CA1.AutomatedSchedulingApp.success> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                grpc.CA1.AutomatedSchedulingApp.profile,
                grpc.CA1.AutomatedSchedulingApp.success>(
                  this, METHODID_INTRODUCE_PROFILE)))
          .addMethod(
            getAbsenceEmptyAgendaMethod(),
            asyncServerStreamingCall(
              new MethodHandlers<
                grpc.CA1.AutomatedSchedulingApp.absenceRequest,
                grpc.CA1.AutomatedSchedulingApp.success>(
  ...
  public static final class TimesheetsBlockingStub extends io.grpc.stub.AbstractStub<TimesheetsBlockingStub> {
    ...
    /**
     */
    public grpc.CA1.AutomatedSchedulingApp.success introduceProfile(grpc.CA1.AutomatedSchedulingApp.profile request) {
    ...
    /**
     */
    public java.util.Iterator<grpc.CA1.AutomatedSchedulingApp.success> absenceEmptyAgenda(
        grpc.CA1.AutomatedSchedulingApp.absenceRequest request) {
  ...
  public static final class TimesheetsFutureStub extends io.grpc.stub.AbstractStub<TimesheetsFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<grpc.CA1.AutomatedSchedulingApp.success> introduceProfile(
        grpc.CA1.AutomatedSchedulingApp.profile request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_INTRODUCE_PROFILE:
          serviceImpl.introduceProfile((grpc.CA1.AutomatedSchedulingApp.profile) request,
              (io.grpc.stub.StreamObserver<grpc.CA1.AutomatedSchedulingApp.success>) responseObserver);
          break;
        case METHODID_ABSENCE_EMPTY_AGENDA:
          serviceImpl.absenceEmptyAgenda((grpc.CA1.AutomatedSchedulingApp.absenceRequest) request,
              (io.grpc.stub.StreamObserver<grpc.CA1.AutomatedSchedulingApp.success>) responseObserver);
          break;
        default:
  ...
  private static abstract class TimesheetsBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return grpc.CA1.AutomatedSchedulingApp.ASAServiceImpl.getDescriptor();
    }
