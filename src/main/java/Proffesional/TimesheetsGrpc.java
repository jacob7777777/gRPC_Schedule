...
public final class TimesheetsGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<Proffesional.profile,
      Proffesional.success> getIntroduceProfileMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "IntroduceProfile",
      requestType = Proffesional.profile.class,
      responseType = Proffesional.success.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<Proffesional.profile,
      Proffesional.success> getIntroduceProfileMethod() {
    io.grpc.MethodDescriptor<Proffesional.profile, Proffesional.success> getIntroduceProfileMethod;
      ...
      synchronized (TimesheetsGrpc.class) {
        if ((getIntroduceProfileMethod = TimesheetsGrpc.getIntroduceProfileMethod) == null) {
          TimesheetsGrpc.getIntroduceProfileMethod = getIntroduceProfileMethod = 
              io.grpc.MethodDescriptor.<Proffesional.profile, Proffesional.success>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "Timesheets", "IntroduceProfile"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  Proffesional.profile.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  Proffesional.success.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<Proffesional.absenceRequest,
      Proffesional.success> getAbsenceEmptyAgendaMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "AbsenceEmptyAgenda",
      requestType = Proffesional.absenceRequest.class,
      responseType = Proffesional.success.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<Proffesional.absenceRequest,
      Proffesional.success> getAbsenceEmptyAgendaMethod() {
    io.grpc.MethodDescriptor<Proffesional.absenceRequest, Proffesional.success> getAbsenceEmptyAgendaMethod;
      ...
      synchronized (TimesheetsGrpc.class) {
        if ((getAbsenceEmptyAgendaMethod = TimesheetsGrpc.getAbsenceEmptyAgendaMethod) == null) {
          TimesheetsGrpc.getAbsenceEmptyAgendaMethod = getAbsenceEmptyAgendaMethod = 
              io.grpc.MethodDescriptor.<Proffesional.absenceRequest, Proffesional.success>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
              .setFullMethodName(generateFullMethodName(
                  "Timesheets", "AbsenceEmptyAgenda"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  Proffesional.absenceRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  Proffesional.success.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<Proffesional.absenceRequest,
      Proffesional.success> getAbsenceFullAgendaMethod;
  ...
  public static io.grpc.MethodDescriptor<Proffesional.absenceRequest,
      Proffesional.success> getAbsenceFullAgendaMethod() {
    io.grpc.MethodDescriptor<Proffesional.absenceRequest, Proffesional.success> getAbsenceFullAgendaMethod;
  ...
  public static abstract class TimesheetsImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void introduceProfile(Proffesional.profile request,
        io.grpc.stub.StreamObserver<Proffesional.success> responseObserver) {
      asyncUnimplementedUnaryCall(getIntroduceProfileMethod(), responseObserver);
    }

    /**
     */
    public void absenceEmptyAgenda(Proffesional.absenceRequest request,
        io.grpc.stub.StreamObserver<Proffesional.success> responseObserver) {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<Proffesional.absenceRequest> absenceFullAgenda(
        io.grpc.stub.StreamObserver<Proffesional.success> responseObserver) {
  ...
  public static final class TimesheetsBlockingStub extends io.grpc.stub.AbstractStub<TimesheetsBlockingStub> {
    ...
    /**
     */
    public Proffesional.success introduceProfile(Proffesional.profile request) {
    ...
    /**
     */
    public java.util.Iterator<Proffesional.success> absenceEmptyAgenda(
        Proffesional.absenceRequest request) {
  ...
  public static final class TimesheetsFutureStub extends io.grpc.stub.AbstractStub<TimesheetsFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<Proffesional.success> introduceProfile(
        Proffesional.profile request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_INTRODUCE_PROFILE:
          serviceImpl.introduceProfile((Proffesional.profile) request,
              (io.grpc.stub.StreamObserver<Proffesional.success>) responseObserver);
          break;
        case METHODID_ABSENCE_EMPTY_AGENDA:
          serviceImpl.absenceEmptyAgenda((Proffesional.absenceRequest) request,
              (io.grpc.stub.StreamObserver<Proffesional.success>) responseObserver);
          break;
        default:
  ...
  private static abstract class TimesheetsBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return Proffesional.proffessionalSchedule.getDescriptor();
    }
