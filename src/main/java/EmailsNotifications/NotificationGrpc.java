...
public final class NotificationGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<EmailsNotifications.answer,
      EmailsNotifications.thanks> getJobConfirmationMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "JobConfirmation",
      requestType = EmailsNotifications.answer.class,
      responseType = EmailsNotifications.thanks.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<EmailsNotifications.answer,
      EmailsNotifications.thanks> getJobConfirmationMethod() {
    io.grpc.MethodDescriptor<EmailsNotifications.answer, EmailsNotifications.thanks> getJobConfirmationMethod;
      ...
      synchronized (NotificationGrpc.class) {
        if ((getJobConfirmationMethod = NotificationGrpc.getJobConfirmationMethod) == null) {
          NotificationGrpc.getJobConfirmationMethod = getJobConfirmationMethod = 
              io.grpc.MethodDescriptor.<EmailsNotifications.answer, EmailsNotifications.thanks>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "Notification", "JobConfirmation"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  EmailsNotifications.answer.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  EmailsNotifications.thanks.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<EmailsNotifications.answer,
      EmailsNotifications.thanks> getTaskChangeMethod;
  ...
  public static io.grpc.MethodDescriptor<EmailsNotifications.answer,
      EmailsNotifications.thanks> getTaskChangeMethod() {
    io.grpc.MethodDescriptor<EmailsNotifications.answer, EmailsNotifications.thanks> getTaskChangeMethod;
  ...
  private static volatile io.grpc.MethodDescriptor<EmailsNotifications.answer,
      EmailsNotifications.thanks> getAbsenceConfirmationMethod;
  ...
  public static io.grpc.MethodDescriptor<EmailsNotifications.answer,
      EmailsNotifications.thanks> getAbsenceConfirmationMethod() {
    io.grpc.MethodDescriptor<EmailsNotifications.answer, EmailsNotifications.thanks> getAbsenceConfirmationMethod;
  ...
  public static abstract class NotificationImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void jobConfirmation(EmailsNotifications.answer request,
        io.grpc.stub.StreamObserver<EmailsNotifications.thanks> responseObserver) {
      asyncUnimplementedUnaryCall(getJobConfirmationMethod(), responseObserver);
    }

    /**
     */
    public void taskChange(EmailsNotifications.answer request,
        io.grpc.stub.StreamObserver<EmailsNotifications.thanks> responseObserver) {
    ...
    /**
     */
    public void absenceConfirmation(EmailsNotifications.answer request,
        io.grpc.stub.StreamObserver<EmailsNotifications.thanks> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                EmailsNotifications.answer,
                EmailsNotifications.thanks>(
  ...
  public static final class NotificationBlockingStub extends io.grpc.stub.AbstractStub<NotificationBlockingStub> {
    ...
    /**
     */
    public EmailsNotifications.thanks jobConfirmation(EmailsNotifications.answer request) {
    ...
    /**
     */
    public EmailsNotifications.thanks taskChange(EmailsNotifications.answer request) {
      return blockingUnaryCall(
    ...
    /**
     */
    public EmailsNotifications.thanks absenceConfirmation(EmailsNotifications.answer request) {
      return blockingUnaryCall(
  ...
  public static final class NotificationFutureStub extends io.grpc.stub.AbstractStub<NotificationFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<EmailsNotifications.thanks> jobConfirmation(
        EmailsNotifications.answer request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<EmailsNotifications.thanks> taskChange(
        EmailsNotifications.answer request) {
      return futureUnaryCall(
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<EmailsNotifications.thanks> absenceConfirmation(
        EmailsNotifications.answer request) {
      return futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_JOB_CONFIRMATION:
          serviceImpl.jobConfirmation((EmailsNotifications.answer) request,
              (io.grpc.stub.StreamObserver<EmailsNotifications.thanks>) responseObserver);
          break;
        case METHODID_TASK_CHANGE:
          serviceImpl.taskChange((EmailsNotifications.answer) request,
              (io.grpc.stub.StreamObserver<EmailsNotifications.thanks>) responseObserver);
          break;
        case METHODID_ABSENCE_CONFIRMATION:
          serviceImpl.absenceConfirmation((EmailsNotifications.answer) request,
              (io.grpc.stub.StreamObserver<EmailsNotifications.thanks>) responseObserver);
          break;
        default:
  ...
  private static abstract class NotificationBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return EmailsNotifications.Notifications.getDescriptor();
    }
